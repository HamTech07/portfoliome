...
export const projects = [
  ...
  },
  {
    ...
    title: "Caloverse",
    category: "Mobile App",
    description: "A focused Android nutrition experience with the latest installable build available in a public download folder.",
    url: "https://drive.google.com/drive/folders/16d8ICzhwzMAsGgWNza-G3SeoLjOug-E0?usp=sharing",
    downloadUrl: "https://drive.google.com/drive/folders/16d8ICzhwzMAsGgWNza-G3SeoLjOug-E0?usp=sharing",
    domain: "APK folder",
    ...
    solution: "A packaged Android build shared through a public portfolio download folder with a mobile-first product experience.",
    highlights: ["Installable Android build", "Public APK folder", "Mobile-first experience"],
  },
];
